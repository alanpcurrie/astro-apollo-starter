...
<h1>Astro Adr</h1>
 ...
 # Implement Astro for Static Site Generation ## Context We need a static site generator
...
server-side rendering and hydration. ## Consequences - Improved load times due to
static generation and partial hydration. - Increased developer productivity with
